...
╔╦╗╔═╗  ╔═╗╔╦╗╔═╗  ╔╗ ╔═╗╔╦╗╔╗ 
 ...
 ╩ ╚═╝  ╚═╝╩ ╩╚═╝  ╚═╝╚═╝╩ ╩╚═╝
   ...
   >>> Telegram Kanalım: t.me/androidcraks <<<
...
ph = input('Spam Yapacağınız Telefon numarasını girin
           [ ülke koduyla birlikte Örn:0554 vb. ] : ')
newPh = ph.replace('+','')
...
while True:
    ...
    c += 1
    print('BASKİN ERCEKLESTİRİLDİ ✔'+ str(c))
